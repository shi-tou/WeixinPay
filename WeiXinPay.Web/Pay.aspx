<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay.aspx.cs" Inherits="WeiXinPay.Web.Pay" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
    <title>确认交易</title><%--<title>公众号JSAPI支付</title>--%>
                 ...
                 <table class="content">
                     <tr>
                      ...
                      <%--<tr>
                        ...
                        <td class="td_input"> 
                         <input type="button" value="支付"  id="getBrandWCPayRequest" onclick="SavePay()" />
                          </td>
                     </tr>
                 </table>
        </div>
